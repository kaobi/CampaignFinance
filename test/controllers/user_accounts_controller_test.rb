...
class UserAccountsControllerTest < ActionController::TestCase
  ...
  test "should create user_account" do
    assert_difference('UserAccount.count') do
      post :create, user_account: { date_created: @user_account.date_created, email: @user_account.email, password: @user_account.password }
    end
  ...
  test "should update user_account" do
    patch :update, id: @user_account, user_account: { date_created: @user_account.date_created, email: @user_account.email, password: @user_account.password }
    assert_redirected_to user_account_path(assigns(:user_account))
  end
