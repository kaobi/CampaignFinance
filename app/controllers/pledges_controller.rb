class PledgesController < ApplicationController
  ...
  private
    ...
    def pledge_params
      params.require(:pledge).permit(:report_id, :transaction_id, :entity_id, :entity_type_id, :travel_id, :candidate_id, :date, :out_of_state_pac, :pac_id, :amount, :description, :date_created, :pledge_total)
    end
end
